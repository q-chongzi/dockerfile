    ...
    <xsl:template match="content">
        <html>
            ...
            <body style="position:relative">
                ...
                <input id="data_operation_validate" type="hidden">
                ...
                <div class="design">
                    ...
                    <div class="configure-fr-side design-side link_data_setting" id="data_setting">
                        <xsl:text disable-output-escaping="no"> </xsl:text>
                    </div>
                </div>
            ...
            <script type="text/javascript" src="diginter/base/zh-cn/js/model.js">
                <xsl:text disable-output-escaping="no"> </xsl:text>
            </script>
