        ...
        <html>
            ...
            <body style="position:relative">
                ...
                <div  style="height:100%">
                    <div class="service-tit2">
                        <ul>
                            ...
                            <xsl:if test="parameter.cludove/is_exchange != 'true'">
                                <li>
                                    <a href="javascript:void(0);" onclick="showCatalogMetadataSetting('','')" class="service1" title="新增功能返回">
                                    </a>
                                </li>
                                <li>
                    ...
                    <div class="configure-fr" id="metadata_setting_main" style="width:100%; height:84%; overflow:auto">

                    </div>
                </div>
                <div class="configure-fr-side configure-fr-one hidden" style="z-index:999" id="metadata_setting_right">
                </div>
            ...
            <script type="text/javascript">
                $(document).ready(function(){setupHttpHeader(); onCatalogMetadataSearch();})
            </script>
        </html>
    </xsl:template>
</xsl:stylesheet>
