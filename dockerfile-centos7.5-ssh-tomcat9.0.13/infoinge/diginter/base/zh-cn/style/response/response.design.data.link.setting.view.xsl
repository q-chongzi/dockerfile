            ...
            <div class="text">
                ...
                <div class="item">
                    ...
                    <xsl:variable name="count">
                        <xsl:value-of select="count(cludove.crest.spruce.data_mapping[2]/record.crest)"/>
                    </xsl:variable>
                    ...
                    <div class="list">
                        ...
                        <input type="hidden" name="connection_code" id="connection_code_data_mapping">
                            <xsl:attribute name="value"><xsl:value-of select="cludove.crest.spruce.data_mapping[1]/record.crest/connection_code"/></xsl:attribute>
                        </input>
