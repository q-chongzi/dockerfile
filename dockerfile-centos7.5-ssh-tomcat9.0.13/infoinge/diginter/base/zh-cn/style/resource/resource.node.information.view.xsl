...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="content">
		<xsl:choose>
			<xsl:when test="cludove.crest.spruce.resource_connection/record.crest/code != ''">
				<form style="padding-left:15px;width:295px" class="form-horizontal configure-form" role="form">
					<p class="connection_node_p">
						<span>连接名字：</span>
					...
					<xsl:if test="cludove.crest.spruce.resource_connection/record.crest/type != 'DB'">
						<p class="connection_node_p">
							<span>位置信息：</span>
					...
					<p style="margin-bottom: 8px;" class="connection_node_p">
