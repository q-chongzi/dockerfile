...
(function($) {
    ...
    var methods = {
        ...
        _validateField: function(field, options, skipAjaxValidation) {
            ...
            if (isAjaxValidator == true && is_ajax == true) {
        ...
        _required: function(field, rules, i, options) {
            ...
            switch (field.prop("type")) {
                ...
                case "select-one":
                    ...
                    if (!field.val()){
                        if (field[0].id=="data_exchange_sync_time_field"){
                            return options.allrules[rules[i]].alertTextData;
                        }else if(field[0].id=="data_exchange_flag_field") {
                            return options.allrules[rules[i]].alertTextData;
                        }else {
                            return options.allrules[rules[i]].alertText;
                        }
        ...
        */
        ...
        _ajax: function(field, rules, i, options) {
            ...
            if (!options.isError) {
                $.ajax({
                    ...
                    cache: false,
                    dataType: "json",
                    data: "fieldId=" + field.attr("id") + "&fieldValue=" + field.val() + "&" + extraData + extraDataDynamic,
                    field: field,
                    rule: rule,
                    methods: methods,
                    options: options,
        ...
        _buildPrompt: function(field, promptText, type, ajaxed, options) {
    	    ...
    	    if (options.relative) {
                ...
                //原为 field.before(outer);修改起父元素，解决自动隐藏问题
            ...
            prompt.css({
                ...
                "left": parseFloat(pos.callerleftPosition) - parseFloat(80),
	...
	$.validationEngine= {defaults:{
        ...
        //原本参数为 false，true 时 生成的提示信息在同一元素内
        isOverflown: true,
        overflownDIV: "",
