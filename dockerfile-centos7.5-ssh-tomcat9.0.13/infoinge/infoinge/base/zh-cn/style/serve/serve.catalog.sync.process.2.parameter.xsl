            ...
            <xsl:otherwise>
                <parameter>
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <IS_SYNCED_ACTIVE>
                                <xsl:value-of select="cludove.crest.spruce.catalog/record.crest[1]/is_synced_active"/>
                            </IS_SYNCED_ACTIVE>

                            <SYNC_ACTIVE_STATUS>
                                <xsl:value-of select="cludove.crest.spruce.catalog/record.crest[1]/sync_active_status"/>
                            </SYNC_ACTIVE_STATUS>
                        </xsl:otherwise>
                    </xsl:choose>
