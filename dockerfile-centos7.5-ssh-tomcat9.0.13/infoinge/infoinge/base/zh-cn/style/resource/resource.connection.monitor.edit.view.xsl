                                ...
                                <div class="list">
                                    ...
                                    <div class="text">
                                        <div class="div_btn">
                                            ...
                                            <xsl:attribute name="onclick">processResourceMonitor('<xsl:value-of select="cludove.crest.spruce.resource_connection/record.crest/code"/>','work')</xsl:attribute>
                                            <xsl:text>允许注册</xsl:text>
                                            </a>
                                            <a href="javascript:void(0)">
                                                <xsl:attribute name="onclick">processResourceMonitor('<xsl:value-of select="cludove.crest.spruce.resource_connection/record.crest/code"/>','refuse')</xsl:attribute>
