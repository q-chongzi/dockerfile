    ...
    <xsl:template match="content">
        <html>
            ...
            <body>
                ...
                <input id="buddle_name" type="hidden">
                    <xsl:attribute name="value">
                ...
                <div class="mianer" style="overflow: hidden">
                    <div class="wrap">
                        <div class="left_side1 row ht2 flt" id="api_catalog"></div>
                    </div>
                </div>
            </body>
        </html>
        <script type="text/javascript">
            $(document).ready(function() {setupHttpHeader(); onApiCatalog($("#buddle_id").val(),$("#buddle_name").val())});
        </script>
    </xsl:template>
</xsl:stylesheet>
